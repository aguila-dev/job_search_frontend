...
export const isLocationInUS = (location) => {
  ...
  const stateAbbr = Object.keys(usaData).find(key =>
    usaData[key].state.toLowerCase() === statePart?.toLowerCase() || key.toLowerCase() === statePart?.toLowerCase()
  );
  ...
  return stateData.cities.some(knownCity => knownCity.toLowerCase() === city.toLowerCase());
};
